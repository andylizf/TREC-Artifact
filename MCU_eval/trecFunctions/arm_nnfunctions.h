...
/**
 * @brief Q7 LCNN convolution function
 * @param[in]       Im_in       pointer to input tensor
 * @param[in]       dim_im_in   input tensor dimension
 * @param[in]       ch_im_in    number of input tensor channels
 * @param[in]       dictionary_size
 * @param[in]       s           number of tensor required to construct linear combination
 * @param[in]       S           pointer to the intermediate output
 * @param[in]       I           
 * @param[in]       C
 * @param[in]       ch_im_out   number of filters, i.e., output tensor channels
 * @param[in]       dim_kernel  filter kernel size
...
/**
 * @brief Fast Q7 version of deep reuse 1x1 convolution (non-sqaure shape)
 * @param[in]       Im_in        pointer to input tensor
 * @param[in]       dim_im_in_x  input tensor dimension x
 * @param[in]       dim_im_in_y  input tensor dimension y
 * @param[in]       ch_im_in     number of input tensor channels
 ...
 *   ch_im_out is multiple of 2
 */
arm_status arm_convolve_1x1_HWC_q7_fast_nonsquare_reuse(const q7_t *Im_in,
                                                  const uint16_t dim_im_in_x,
                                                  const uint16_t dim_im_in_y,
                                                  const uint16_t ch_im_in,
                                                  const q7_t *wt,
...
/**
 * @brief Q7 depthwise separable convolution function (non-square shape, deep reuse version)
 * @param[in]       Im_in         pointer to input tensor
 * @param[in]       dim_im_in_x   input tensor dimension x
 * @param[in]       dim_im_in_y   input tensor dimension y
 * @param[in]       ch_im_in      number of input tensor channels
 ...
 *   ch_im_out is multiple of 2
 */
arm_status arm_depthwise_separable_conv_HWC_q7_nonsquare_reuse(const q7_t *Im_in,
                                                         const uint16_t dim_im_in_x,
                                                         const uint16_t dim_im_in_y,
                                                         const uint16_t ch_im_in,
                                                         const q7_t *wt,
 ...
 *
 */
arm_status arm_fully_connected_mat_q7_vec_q15_batch(const q7_t *Im_in,
                                                  const uint16_t dim_im_in_x,
                                                  const uint16_t dim_im_in_y,
                                                  const uint16_t ch_im_in,
                                                  const q7_t *wt,
 ...
 *
 */
arm_status arm_fully_connected_mat_q7_vec_q15_batch_reuse(const q7_t *Im_in,
                                                  const uint16_t dim_im_in_x,
                                                  const uint16_t dim_im_in_y,
                                                  const uint16_t ch_im_in,
                                                  const q7_t *wt,
