...
"""Contains the definition of the SqueezeNet architecture.
...
class Fire(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, squzee_channel, params_L=[1]*3, params_H=[1]*3, trec=[0]*3, idx=0):
...
def squeezenet_trec(params_L, params_H, trec=[0]*(8*3+2), class_num=10):
    return SqueezeNet_TREC(params_L, params_H, trec=trec, class_num=class_num)