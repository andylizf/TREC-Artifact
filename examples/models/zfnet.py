...
class ZFNet(nn.Module):
    def __init__(self, params_L, params_H, dr=[0]*5, num_classes=10):
        ...
        # layer 1
        if dr[0]:
            self.conv1 = Conv2d_TREC(3, 96, 7, params_L[0], params_H[0], 0, stride=2, padding=1)
        else:                
        ...
        # layer 2
        if dr[1]:
            self.conv2 = Conv2d_TREC(96, 256, 5, params_L[1], params_H[1], 1, stride=2)
        else:                
        ...
        # layer 3
        if dr[2]:
            self.conv3 = Conv2d_TREC(256, 384, 3, params_L[2], params_H[2], 2, stride=1, padding=1)
        else:                
        ...
        # layer 4
        if dr[3]:
            self.conv4 = Conv2d_TREC(384, 384, 3, params_L[3], params_H[3], 3, stride=1, padding=1)
        else:                
        ...
        # layer 5
        if dr[4]:
            self.conv5 = Conv2d_TREC(384, 256, 3, params_L[4], params_H[4], 4, stride=1, padding=1)
        else:                
